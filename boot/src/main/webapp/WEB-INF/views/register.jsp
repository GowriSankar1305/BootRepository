...
$(function()	{
	$('#submitBtn').click(function()	{
		 $('#signUpFrm').attr("action","${pageContext.servletContext.contextPath}/saveUser");
                ...
                <div class="card-body">
                    <form method="POST" id="signUpFrm">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="email" name="emailId" id="emailId">
                                </div>
                            </div>
                        </div>
                        <div class="form-row m-b-55">
                            ...
                            <div class="value">
                                <div class="row row-refine">
                                    <div class="col-3">
                                        <div class="input-group-desc">
                                            <input class="input--style-5" type="text" name="areaCode" id="areaCode">
                                            <label class="label--desc">Area Code</label>
                                        </div>
                                    </div>
                                    <div class="col-9">
                                        <div class="input-group-desc">
                                            <input class="input--style-5" type="text" name="mobileNo" id="mobileNo">
